...
|------|------------|----------|-----------|----------------|-------------------|----------|
| `prompt-engineering` | `stable` | Taxonomy prompt engineering hiện đại: 4 nhóm lớn, 24 kỹ thuật, cập nhật từ survey 2024-2026 và docs OpenAI / Anthropic / Google / Microsoft | [`reports/prompt-engineering/index.astro`](../report-kit/src/pages/reports/prompt-engineering/index.astro) | [`research/prompt-engineering/`](../report-kit/research/prompt-engineering/) | — | 2026-04-22 |
| `prompt-engineering/cot` | `stable` | Deep dive: Chain-of-Thought / zero-shot CoT — reasoning scaffold, monitorability và controllability | [`reports/prompt-engineering/cot.astro`](../report-kit/src/pages/reports/prompt-engineering/cot.astro) | — | — | 2026-04-22 |
| `prompt-engineering/plan-solve` | `stable` | Deep dive: Plan-and-Solve / Least-to-Most — decomposition-first reasoning, easy-to-hard generalization | [`reports/prompt-engineering/plan-solve.astro`](../report-kit/src/pages/reports/prompt-engineering/plan-solve.astro) | — | — | 2026-04-22 |
| `prompt-engineering/tot-got` | `stable` | Deep dive: Tree-of-Thought / Graph-of-Thought — branching search, scoring và backtracking | [`reports/prompt-engineering/tot-got.astro`](../report-kit/src/pages/reports/prompt-engineering/tot-got.astro) | — | — | 2026-04-22 |
| `prompt-engineering/self-consistency` | `stable` | Deep dive: Self-consistency — sampling nhiều reasoning path rồi vote trên final answer | [`reports/prompt-engineering/self-consistency.astro`](../report-kit/src/pages/reports/prompt-engineering/self-consistency.astro) | — | — | 2026-04-22 |
| `prompt-engineering/react` | `stable` | Deep dive: ReAct / tool-augmented reasoning — thought, action, observation loop | [`reports/prompt-engineering/react.astro`](../report-kit/src/pages/reports/prompt-engineering/react.astro) | — | — | 2026-04-22 |
| `prompt-engineering/prompt-chaining` | `stable` | Deep dive: Prompt chaining — inspectable multi-step pipelines với artifact trung gian | [`reports/prompt-engineering/prompt-chaining.astro`](../report-kit/src/pages/reports/prompt-engineering/prompt-chaining.astro) | — | — | 2026-04-22 |
| `prompt-engineering/pal-pot` | `stable` | Deep dive: PAL / Program-of-Thought — code as intermediate representation | [`reports/prompt-engineering/pal-pot.astro`](../report-kit/src/pages/reports/prompt-engineering/pal-pot.astro) | — | — | 2026-04-22 |
| `prompt-engineering/self-refine` | `stable` | Deep dive: Self-refine + external verification — draft, critique, revise, verify | [`reports/prompt-engineering/self-refine.astro`](../report-kit/src/pages/reports/prompt-engineering/self-refine.astro) | — | — | 2026-04-22 |
| `prompt-engineering/prompt-ensembling` | `stable` | Deep dive: Prompt ensembling — bagging/boosting style reliability at inference time | [`reports/prompt-engineering/prompt-ensembling.astro`](../report-kit/src/pages/reports/prompt-engineering/prompt-ensembling.astro) | — | — | 2026-04-22 |
| `prompt-engineering/prompt-optimization` | `stable` | Deep dive: Automatic prompt optimization — dataset, graders và review loop | [`reports/prompt-engineering/prompt-optimization.astro`](../report-kit/src/pages/reports/prompt-engineering/prompt-optimization.astro) | — | — | 2026-04-22 |
| `prompt-engineering/structured-outputs` | `stable` | Deep dive: Structured outputs / strict mode / allowed tools — contract hóa output | [`reports/prompt-engineering/structured-outputs.astro`](../report-kit/src/pages/reports/prompt-engineering/structured-outputs.astro) | — | — | 2026-04-22 |
| `prompt-engineering/safety-guardrails` | `stable` | Deep dive: Safety and injection defenses — defense-in-depth cho agentic prompts | [`reports/prompt-engineering/safety-guardrails.astro`](../report-kit/src/pages/reports/prompt-engineering/safety-guardrails.astro) | — | — | 2026-04-22 |
...
- **Prompt engineering hiện đại = instruction + context + reasoning + reliability**. Đọc tốt nhất như một stack chứ không phải danh sách mẹo; 2024-2026 survey và vendor docs đều đang dịch theo hướng này.

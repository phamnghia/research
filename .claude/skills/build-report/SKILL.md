...
Tham chiếu: `Research/CLAUDE.md`, `Research/report-kit/README.md`, `Research/report-kit/src/pages/reports/_template.astro`, `Research/report-kit/src/pages/components.astro`.
...
- **So sánh** — có cần so với sản phẩm nào không (vd với Claude Code / opencode).
